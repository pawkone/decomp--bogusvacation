...
if (instance_exists(obj_player2))
    target = [mean(cam_tar.x, obj_player2.x), mean(cam_tar.y, obj_player2.y)];
...
if (cam_tar == obj_player1)
{
    ...
    if (cam_tar.state == states.running || cam_tar.state == states.runningjump || cam_tar.state == states.cape)
    {
...
cupx = lerp(cupx, 266 + (56 * (global.hp - 4)), 0.25);
cupy = 12 + cupoffset;
